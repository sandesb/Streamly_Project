...
<head>
  ...
  <title>Streamly | Centralized Streaming Platform</title>
...
<body>
  <div class="tv-1">
    ...
    <b class="stream-all-your-container">
      ...
      <p class="stream-all-your">favorites and more.</p>
    </b>
    ...
    <div class="rectangle-parent">
      <form action="/Stream/LoginServ?page=fav" method="POST">
        <input class="group-child" type="text" name="fav" placeholder="Enter Your Email..." />
    ...
    <nav id="navbar" class="navbar-expand-lg navbar-light " style="background-color:#040714">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <p style="padding-left: 15px; padding-top: 20px; font-size: 20px;">Stream.ly</p>
            <li></li>
          </ul>
          <a href="admin-in.jsp"><button style="margin-right: 15px;
                     
                     left: calc(50% - 171px/2 + 358px);
border-bottom-color: #FFFBEB;
border-bottom-width: 2px;
border-radius: 15px;" class="btn btn-outline-light" type="submit">Streamly</button></a>
      ...
      %>" <button class="btn btn-outline-light" type="submit">Streamer</button></a>
