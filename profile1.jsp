   ...
   <div class="first-flex">
            ...
            <nav>
                <ul class="ul-flex">
                    <div class="home-flex">
                        ...
                        <li class="home1">
                            <a href="/Stream/mediaServ?page=home&uid=${user.uid}" style="font-weight: lighter;">Home</a></li>
                    </div>
                      <div class="home-flex">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <p class="para-format"
                style="font-family: Jaldi; font-weight: lighter; font-size: 150%; margin:5% 0 0% 0;padding-left: 12%;  color:#ffffff;">
                USER PROFILE</p>
                        ...
                        <div class="col col-xl-10">
                            <div class="card mb-5"
                                ...
                                <div class="card-body p-4"
                                    ...
                                    <h3 class="mb-3 text-light"> <%=session.getAttribute("fullname")%>  </h3>
                                        ...
                                        <strong class="text-light">Created on 11 April , 2021</p>
                                            ...
                                            <div class="d-flex justify-content-start align-items-center">
                                                <p class="mb-0 text-uppercase px-2"><a href="playlists.jsp"> <span
                                                            class="text-muted small">Saved</span></a></p>
                                                <p class="mb-0 text-uppercase">
                                                    <a href="/Stream/UserServlet?page=userEdit&edit=<%=session.getAttribute("uid")%> "><span
