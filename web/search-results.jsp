   ...
   //here sonoo is database name, root is username and password  
            ...
            <div class="play-flex">
                ...
                <div class="card"
                    ...
                    <a href="/Stream/mediaServ?page=newlist&mid=<%=rs.getString("mid")%>"> <img class="card-img-top" src="img/<%=rs.getString("thumb")%>" alt="Card image cap">
                    <div class="card-body">

                        <h5 class="card-title" style="color:white; display: inline-block;"><%=rs.getString("name")%></h5>
                        <a class="save-button" data-toggle="modal" data-target="#exampleModalCenter"><img
         style="float: right;  padding-right: 4%; width: 15%;" src="img/sun1.png"></a>
...
<!--
        <div class="friend">
            <div class="friend-flex">
                ...
                <div><img class="friends-pic" src="img/pp.png"></div>
                <div><img class="friends-pic" src="img/pp.png"></div>
                <div><img class="friends-pic" src="img/pp.png"></div>
                <div><img class="friends-pic" src="img/pp.png"></div>
