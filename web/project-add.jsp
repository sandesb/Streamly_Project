...
<head>
  ...
  <title>Admin Portal | Media Add</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="project-add.jsp" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Content</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-lg-12" style="padding-left: 25.5px;padding-right: 22.5px;">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="/Stream/LoginServ?page=media" method="POST">
                  <div class="form-group">
                    <label for="inputName">Content Name</label>
                  ...
                  <div class="form-group">
                    ...
                    <select name="genre" id="inputStatus" class="form-control custom-select">
                  ...
                  <div class="form-group">
                    <label for="inputProjectLeader">Released Year</label>
                    <input type="text" name="year" id="inputProjectLeader" class="form-control">
                  </div>
                  <div class="input-group">
                    <div class="custom-file">
                      <div class="custom-file">
                        <input name="thumb" type="file" class="custom-file-input" id="customFile">
