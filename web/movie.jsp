            ...
            <div class="content-grid">
                <div class="container">
                    <c:forEach items="${mediaList}" var="name">
                        ...
                        <div class="main-video-container">
                            <video src="star-wars1.mp4" loop controls class="main-video"></video>
                        </div>
                ...
                <div class="categ-flex-grid">
                    <div class="categ-flex">
                        <div class="title1">
                            <div class="some">
                                <div class="categ-name">${name.categ}</div>
                            </div>
                            <div class="some">
                                <div class="categ-name">${name.genre}</div>
                            </div>
                        </div>
                    ...
                    <div class="categ-flex">
                        ...
                        <div class="title1">
                            ...
                            <div class="title-name">${name.name}</div>
                        </div>
                    </div>
                    <div class="categ-flex">
                        <!-- first parent flex -->
