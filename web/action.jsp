...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="play-flex">
                <c:forEach items="${mediaList}" var="cat">

                    <div class="card"
                        style="width: 15rem; box-shadow: 4px 6px 0px rgba(66, 84, 128, 0.308); margin-left:6%; margin-bottom: 5%; background-color: #1E1F26;">
                        <img class="card-img-top" src="${cat.thumb}" alt="Card image cap">
                        <div class="card-body">

                            <h5 class="card-title" style="color:white; display: inline-block;">${cat.name}</h5>
                            <a class="save-button" data-toggle="modal" data-target="#exampleModalCenter"><img
                                    style="float: right;  padding-right: 4%; width: 65%;" src="img/sun1.png"></a>
                ...
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title" style="color:white; display: inline-block;">The Hulk</h5>
                        <a class="save-button" data-toggle="modal" data-target="#exampleModalCenter"><img
                                style="float: right;  padding-right: 4%; width: 65%;" src="img/sun1.png"></a>
