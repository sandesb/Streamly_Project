        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <div class="main-video-container">
                    ...
                    <h3 class="main-vid-title">${media.name}</h3>
                </div>

                <div class="video-list-container">

                    <div class="list active">
                        <video src="video/${media.video}" class="list-video"></video>
                        <h3 class="list-title">Episode 1</h3>
                    </div>

                    <div class="list">
                        <video src="disney/hansa.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 2</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 3</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-4.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 4</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-5.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 5</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-6.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 6</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-7.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 7</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-8.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 8</h3>
                    </div>

                    <div class="list">
                        <video src="video playlist/images/vid-9.mp4" class="list-video"></video>
                        <h3 class="list-title">Episode 9</h3>
                    </div>
...
<!--        <div class="friend">
    ...
    <script src="video playlist/js/script.js"></script>
